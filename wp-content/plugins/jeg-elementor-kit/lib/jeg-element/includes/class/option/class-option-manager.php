	...
	public function build_module_option( $customizer ) {
		if ( apply_filters( 'jeg_show_default_module_customizer', true ) ) {
			$customizer->add_panel( array(
				'id'          => 'jeg_module_panel',
				'title'       => apply_filters( 'jeg_module_element_option_label', esc_html__( 'JEG : Module Element Option', 'jeg-element' ) ),
				'description' => esc_html__( 'Jeg ', 'jeg-element' ),
				'priority'    => 171,
			) );

			$customizer->add_section( array(
				'id'         => 'jeg_module_image_section',
				'title'      => esc_html__( 'Module Image Setting', 'jeg-element' ),
			...
			$customizer->add_section( array(
				...
				'title'      => esc_html__( 'Module Loader', 'jeg-element' ),
				'panel'      => 'jeg_module_panel',
				'priority'   => 171,
				'type'       => 'jeg-lazy-section',
				'dependency' => array(),
			...
			$customizer->add_section( array(
				...
				'title'      => esc_html__( 'Module Meta Option', 'jeg-element' ),
				'panel'      => 'jeg_module_panel',
				'priority'   => 171,
				'type'       => 'jeg-lazy-section',
				'dependency' => array(),
			...
			$customizer->add_section( array(
				...
				'title'      => esc_html__( 'Module Custom Post Type', 'jeg-element' ),
				'panel'      => 'jeg_module_panel',
				'priority'   => 171,
				'type'       => 'jeg-lazy-section',
				'dependency' => array(),
			...
			$customizer->add_section( array(
				...
				'title'      => esc_html__( 'Module Global Font', 'jeg-element' ),
				'panel'      => 'jeg_module_panel',
				'priority'   => 171,
				'type'       => 'jeg-lazy-section',
				'dependency' => array(),
