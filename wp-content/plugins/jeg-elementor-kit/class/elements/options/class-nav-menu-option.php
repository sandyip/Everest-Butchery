...
class Nav_Menu_Option extends Option_Abstract {
	...
	public function additional_style() {
		...
		$this->options['st_submenu_item_border_first'] = array(
			...
			'segment'   => 'style_submenu_item',
			'selectors' => '.jeg-elementor-kit.jkit-nav-menu .jkit-menu-wrapper .jkit-menu .sub-menu li:first-child',
		);
		...
		$this->options['st_submenu_item_border_last'] = array(
			...
			'segment'   => 'style_submenu_item',
			'selectors' => '.jeg-elementor-kit.jkit-nav-menu .jkit-menu-wrapper .jkit-menu .sub-menu li:last-child',
		);
