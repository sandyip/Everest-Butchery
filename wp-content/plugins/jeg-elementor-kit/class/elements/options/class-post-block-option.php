...
class Post_Block_Option extends Option_Abstract {
	...
	public function additional_style() {
		...
		$this->options['st_pagination_padding'] = array(
			...
			'segment'   => 'style_pagination',
			'units'     => array( 'px', 'em' ),
			'selectors' => '.jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore',
			'attribute' => 'padding',
		);
		...
		$this->options['st_pagination_icon_spacing'] = array(
			...
			'selectors'  => array(
				'custom' => array(
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore.icon-position-before i, {{WRAPPER}} .jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore.icon-position-before svg' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore.icon-position-after i, {{WRAPPER}} .jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore.icon-position-after svg'   => 'margin-left: {{SIZE}}{{UNIT}};',
				),
			),
		);
		...
		$this->options['st_pagination_icon_size'] = array(
			...
			'selectors'  => array(
				'custom' => array(
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore i'   => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore svg' => 'width: {{SIZE}}{{UNIT}};',
				),
			),
		);
		...
		$this->options['st_pagination_normal_color']     = array(
			...
			'selectors'  => array(
				'custom' => array(
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore, {{WRAPPER}} .jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore svg'                                                                                          => 'fill: {{VALUE}};',
				),
			),
		);
		...
		$this->options['st_pagination_hover_color'] = array(
			...
			'selectors'  => array(
				'custom' => array(
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore:hover, {{WRAPPER}} .jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore:hover a' => 'color: {{VALUE}};',
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore:hover svg'                                                                                                => 'fill: {{VALUE}};',
				),
			),
		);
		...
		$this->options['st_pagination_hover_background'] = array(
			...
			'title'     => esc_html__( 'Hover Background', 'jeg-elementor-kit' ),
			'segment'   => 'style_pagination',
			'selectors' => '.jeg-elementor-kit.jkit-postblock .jkit-block-pagination .jkit-block-loadmore:hover',
			'options'   => array(
				'classic',
				'gradient',
			),
