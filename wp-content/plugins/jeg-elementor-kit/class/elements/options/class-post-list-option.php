...
class Post_List_Option extends Option_Abstract {
	...
	public function additional_style() {
		...
		$this->options['st_pagination_icon_spacing'] = array(
			...
			'selectors'  => array(
				'custom' => array(
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postlist .jkit-block-pagination .jkit-block-loadmore.icon-position-before i, {{WRAPPER}} .jeg-elementor-kit.jkit-postlist .jkit-block-pagination .jkit-block-loadmore.icon-position-before svg' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postlist .jkit-block-pagination .jkit-block-loadmore.icon-position-after i, {{WRAPPER}} .jeg-elementor-kit.jkit-postlist .jkit-block-pagination .jkit-block-loadmore.icon-position-after svg'   => 'margin-left: {{SIZE}}{{UNIT}};',
				),
			),
		);
		...
		$this->options['st_pagination_icon_size'] = array(
			...
			'selectors'  => array(
				'custom' => array(
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postlist .jkit-block-pagination .jkit-block-loadmore i'   => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postlist .jkit-block-pagination .jkit-block-loadmore svg' => 'width: {{SIZE}}{{UNIT}};',
				),
			),
		);
		...
		$this->options['st_pagination_normal_color']     = array(
			...
			'selectors'  => array(
				'custom' => array(
					...
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postlist .jkit-block-pagination .jkit-block-loadmore svg'                                                                                         => 'fill: {{VALUE}}',
				),
			),
		);
		...
		$this->options['st_pagination_hover_color'] = array(
			...
			'selectors'  => array(
				'custom' => array(
					...
					'{{WRAPPER}} .jeg-elementor-kit.jkit-postlist .jkit-block-pagination .jkit-block-loadmore:hover svg'                                                                                               => 'fill: {{VALUE}}',
				),
			),
		);
