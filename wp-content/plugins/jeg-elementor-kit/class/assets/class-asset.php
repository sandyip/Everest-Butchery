...
class Asset {
	...
	public function load_frontend_assets() {
		...
		wp_register_style( 'magnific-popup', JEG_ELEMENTOR_KIT_URL . '/assets/js/magnific-popup/magnific-popup.css', array(), '1.1.0' );
	...
	public function load_frontend_scripts() {
		...
		wp_register_script( 'magnific-popup', JEG_ELEMENTOR_KIT_URL . '/assets/js/magnific-popup/jquery.magnific-popup.min.js', null, '1.1.0', true );
		wp_register_script( 'chartjs', JEG_ELEMENTOR_KIT_URL . '/assets/js/chartjs/chart.min.js', null, '2.9.4', true );
