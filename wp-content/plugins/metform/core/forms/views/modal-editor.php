...
<div class="attr-modal attr-fade" id="metform_form_modal" tabindex="-1" role="dialog" aria-labelledby="metform_form_modalLabel" style="display:none;">
    <div class="attr-modal-dialog attr-modal-dialog-centered" id="metform-form-modalinput-form" role="document">
        <form action="" mathod="post" id="metform-form-modalinput-settings" data-open-editor="0" data-editor-url="<?php echo get_admin_url(); ?>" data-nonce="<?php echo wp_create_nonce('wp_rest'); ?>">
            ...
            <div class="attr-modal-content">
                                    ...
                                    <div class="mf-input-group">
                                        ...
                                        <span class='mf-input-help'>
                                            ...
                                            <strong><?php esc_html_e('The form must have at least one Email widget and it should be required. ', 'metform'); ?>
                                                <a target="_blank" href="<?php echo get_dashboard_url() . 'admin.php?page=metform-menu-settings#mf-newsletter_integration'; ?>">
                        ...
                        <div role="tabpanel" class="attr-tab-pane" id="mf-crm">
                            ...
                            <div class="attr-modal-body" id="metform_form_modal_body">
                                ...
                                <div class="mf-input-group">
                                    ...
                                    <span class='mf-input-help'><?php esc_html_e('Integrate hubspot with this form. ', 'metform'); ?><a target="_blank" href="<?php echo get_dashboard_url() . 'admin.php?page=metform-menu-settings'; ?>"><?php esc_html_e('Configure Hubspot.', 'metform'); ?></a></span>
                                </div>
                                ...
                                <div class="mf-input-group">
                                    ...
                                    <span class='mf-input-help'><?php esc_html_e('Integrate Zoho contacts with this form. ', 'metform'); ?><a target="_blank" href="<?php echo get_dashboard_url() . 'admin.php?page=metform-menu-settings'; ?>"><?php esc_html_e('Configure Zoho.', 'metform'); ?></a></span>
                                </div>
                                ...
                                <div class="mf-input-group">
                                    ...
                                    <span class='mf-input-help'><?php esc_html_e('Integrate Helpscout with this form. ', 'metform'); ?><a target="_blank" href="<?php echo get_dashboard_url() . 'admin.php?page=metform-menu-settings'; ?>"><?php esc_html_e('Configure Helpscout.', 'metform'); ?></a></span>
                ...
                <div class="attr-modal-footer">
                    <button type="button" class="attr-btn attr-btn-default metform-form-save-btn-editor"><img class="form-editor-icon" src="<?php echo \MetForm\Plugin::instance()->public_url() . 'assets/img/elementor-edit-logo.png'; ?>"><?php esc_html_e('Edit content', 'metform'); ?>
                    </button>
